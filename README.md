...
A cpp implementation of recognize-onnx.py in [Went](https://www.runoob.com) in which it implements the infererence with ONNXRuntime. For a version of pure CPP code, we need to do a bit of work to rewrite some components.
